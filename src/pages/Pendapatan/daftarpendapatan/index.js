...
import { getDataTipePendapatan, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/Pendapatan';
import { ModalConfirm } from '../../../component/atom/Notifikasi';

const DaftarPendapatan = () => {    
    // State
    ...
    const statePendapatan = useSelector(state => state.pendapatan);
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataTipePendapatan({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: statePendapatan.dataTipePendapatan.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: statePendapatan.dataTipePendapatan.total,
        ...
        <div className="animated fadeIn">
            <div className="card">
                <div className="card-header">
                    <i className="icon-user"></i> DAFTAR PENDAPATAN {stateRoot.name}
                </div>
...
export default DaftarPendapatan;
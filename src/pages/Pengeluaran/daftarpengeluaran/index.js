...
import { getDataDaftarPengeluaran, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/Pengeluaran';
...
const DaftarPengeluaran = () => {    
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataDaftarPengeluaran({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: statepengeluaran.dataDaftarPengeluaran.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: statepengeluaran.dataDaftarPengeluaran.total,
        ...
        <div className="animated fadeIn">
            <div className="card">
                <div className="card-header">
                    <i className="icon-user"></i> DAFTAR PENGELUARAN {stateRoot.name}
                </div>

...
import { getDataTipeCuti, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/SumberDayaManusia';
...
const TipeCuti = () => {    
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataTipeCuti({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: stateSumberDayaManusia.dataTipeCuti.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: stateSumberDayaManusia.dataTipeCuti.total,
        ...
        <div className="animated fadeIn">
            <div className="card">
                <div className="card-header">
                    <i className="icon-user"></i> TIPE CUTI {stateRoot.name}
                </div>

...
import { getDataPencapaianNilai, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/Ujian';
import { ModalConfirm } from '../../../component/atom/Notifikasi';

const PencapaianNilai = () => {    
    // State
    ...
    const stateujian = useSelector(state => state.ujian);
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataPencapaianNilai({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: stateujian.dataPencapaianNilai.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: stateujian.dataPencapaianNilai.total,
        ...
        <div className="animated fadeIn">
            <div className="card">
                <div className="card-header">
                    <i className="icon-user"></i> PENCAPAIAN NILAI {stateRoot.name}
                </div>
...
export default PencapaianNilai;
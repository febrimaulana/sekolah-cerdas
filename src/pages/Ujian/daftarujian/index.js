...
import { getDataDaftarUjian, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/Ujian';
...
const DaftarUjian = () => {    
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataDaftarUjian({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: stateujian.dataDaftarUjian.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: stateujian.dataDaftarUjian.total,

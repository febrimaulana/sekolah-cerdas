...
import { getDataDiskonBiaya, addDataSiswa, deleteDataSiswa, updateDataSiswa } from '../../../config/redux/action/DaftarBiaya';
...
const DiskonBiaya = () => {    
    ...
    const onCreate =  async (values, status) => {        
        ...
        if (status === 'tambah') {                                  
            ...
            dispatch(getDataDiskonBiaya({pagination: pagination}));
        } else if (status === 'ubah') {            
    ...
    const dataTable = {
        ...
        dataRow: statedaftarbiaya.dataDiskonBiaya.data,
        idRow: 'id_siswa',
    ...
    const dataPagination = {
        ...
        countData: statedaftarbiaya.dataDiskonBiaya.total,
        ...
        <div className="animated fadeIn">
            <div className="card">
                <div className="card-header">
                    <i className="icon-user"></i> DAFTAR DISKON BIAYA {stateRoot.name}
                </div>

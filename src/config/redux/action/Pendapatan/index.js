...
export const getDataTipePendapatan = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/read-student`, data.pagination).then((res) => {
            let data = res.data;                      
            console.log(data);
            dispatch({ type: 'SET_DATA_TIPE_PENDAPATAN', value: data });
...
export const getDataDaftarPendapatan = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/read-student`, data.pagination).then((res) => {
            let data = res.data;  
...
export const addDafatarPendapatan = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/create-student`, data).then((res) => {
            let data = res.data;
...
export const deleteDaftarPendapatan = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/delete-student`, data).then((res) => {
            let data = res.data;            
...
export const updateDaftarPendapatan = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/update-student`, data).then((res) => {
            let data = res.data;            

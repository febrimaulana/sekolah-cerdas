...
export const getDataDaftarPengeluaran = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/read-student`, data.pagination).then((res) => {
            let data = res.data;                      
            console.log(data);
            dispatch({ type: 'SET_DATA_DAFTAR_PENGELUARAN', value: data });
...
export const getDataTipePengeluaran = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/read-student`, data.pagination).then((res) => {
            let data = res.data;  
            console.log(data);                     
            console.log(data);
            dispatch({ type: 'SET_DATA_TIPE_PENGELUARAN', value: data });
            dispatch({ type: 'SET_LOADING', value: false });
            resolve(data);
        }).catch((err) => {
            console.log(err);
...
export const addDataTipePengeluaran = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/create-student`, data).then((res) => {
            let data = res.data;
...
export const deleteDataTipePengeluaran = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/delete-student`, data).then((res) => {
            let data = res.data;            
...
export const updateDataTipePengeluaran = (data) => (dispatch) => {    
    return new Promise((resolve, reject) => {
        dispatch({ type: 'SET_LOADING', value: true })
        axios.post(`http://153.92.5.209:3000/services/update-student`, data).then((res) => {
            let data = res.data;            
